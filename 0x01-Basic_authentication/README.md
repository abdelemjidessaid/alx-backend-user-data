...
![](./images/1707836670393.png)

## Resources

**Read or watch**:

- [REST API Authentication Mechanisms](https://www.youtube.com/watch?v=501dpx2IjGY&themeRefresh=1 'REST API Authentication Mechanisms')
...
Download and start your project from this [archive.zip](https://intranet.alxswe.com/rltoken/2o4gAozNufil%5FKjoxKI5bA 'archive.zip')
...
- Based on the environment variable `AUTH_TYPE`, load and assign the right instance of authentication to `auth`
  - if `auth`:  
     _ import `Auth` from `api.v1.auth.auth`  
     _ create an instance of `Auth` and assign it to the variable `auth`
